...
public class MainActivity extends AppCompatActivity {
    ...
    TextView errorMessageDisplay = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        errorMessageDisplay = (TextView) findViewById(R.id.action_error);

        // TODO (17) Find the ProgressBar using findViewById
        progressBar = (ProgressBar) findViewById(R.id.action_progressbar);
